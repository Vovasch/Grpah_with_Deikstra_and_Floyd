...
public:
	...
	void Push_Value(T value, int string, int column) {	matrix[string][column] = value;	}

	inline T Get_Value(int string, int column) const { return this->matrix[string][column]; }
